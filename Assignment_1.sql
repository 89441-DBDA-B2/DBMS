CREATE database spj;
use spj;
CREATE TABLE S('S#' CHAR(5) NOT NULL, Sname CHAR(20), status SMALLINT, city CHAR(20), status SMALLINT, city CHAR(15));

CREATE TABLE P('P#' CHAR(6) NOT NULL, Pname CHAR(20), color CHAR(6), weight SMALLINT , city CHAR(15));

CREATE TABLE J(`J#` CHAR(4) NOT NULL, Jname CHAR(10), City CHAR(10));
INSERT INTO J(`J#`, Jname, City) VALUES('J1', 'Sorter' , 'Paris'),('J1','Punch', 'Rome');
INSERT INTO J(`J#`, Jname, City) VALUES('J3', 'Reader' , 'Athens'),('J4','Console', 'Athens');
INSERT INTO J(`J#`, Jname, City) VALUES('J5', 'Collator' , 'London'),('J6','Terminal', 'Oslo'),('J7','Tape','London');
...
INSERT  INTO sp VALUES('s2','p3','J2',2000),('S2','P3','J3',200),('S2','P3','J4',500),('S2','P3','J5',600),('S2','P3','J7',800);
INSERT  INTO sp VALUES('s2','p3','J7',800),('S2','P5','J2',100),('S2','P5','J2',100),('S3','P3','J1',200),('S3','P4','J2',500);
